...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/TTTo2L2Nu_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM')
)
...
process.EmuVetoLeptons = cms.EDProducer("Zprime2muLeptonProducer_miniAOD",
    bits = cms.InputTag("TriggerResults","","HLT"),
    electron_id = cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV70"),
    electron_muon_veto_dR = cms.double(0.1),
...
process.EmuVetoMuonsElectronsAllSigns = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    ...
    src = cms.InputTag("allEmuVetoMuonsElectronsAllSigns"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsElectronsOppSign = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsElectronsOppSign"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsElectronsSameSign = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsElectronsSameSign"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsMinusElectronsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsMinusElectronsMinus"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsMinusElectronsPlus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsMinusElectronsPlus"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsPlusElectronsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsPlusElectronsMinus"),
    vertex_chi2_max = cms.double(20)
)


process.EmuVetoMuonsPlusElectronsPlus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allEmuVetoMuonsPlusElectronsPlus"),
    vertex_chi2_max = cms.double(20)
)
...
process.Our2016MuonsElectronsAllSigns = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsElectronsAllSigns"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuonsElectronsOppSign = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsElectronsOppSign"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuonsElectronsSameSign = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsElectronsSameSign"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuonsMinusElectronsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsMinusElectronsMinus"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuonsMinusElectronsPlus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsMinusElectronsPlus"),
    vertex_chi2_max = cms.double(20)
)
...
process.Our2016MuonsPlusElectronsMinus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsPlusElectronsMinus"),
    vertex_chi2_max = cms.double(20)
)


process.Our2016MuonsPlusElectronsPlus = cms.EDProducer("Zprime2muCompositeCandidatePicker",
    back_to_back_cos_angle_min = cms.double(-0.9998),
    cut = cms.string(''),
    do_remove_overlap = cms.bool(True),
    dpt_over_pt_max = cms.double(0.3),
    max_candidates = cms.uint32(1),
    sort_by_pt = cms.bool(True),
    src = cms.InputTag("allOur2016MuonsPlusElectronsPlus"),
    vertex_chi2_max = cms.double(20)
)
...
process.allEmuVetoMuonsElectronsAllSigns = cms.EDProducer("Zprime2muCombiner",
    checkCharge = cms.bool(False),
    cut = cms.string(''),
    decay = cms.string('EmuVetoLeptons:muons@+ EmuVetoLeptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
)


process.allEmuVetoMuonsElectronsOppSign = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string(''),
    decay = cms.string('EmuVetoLeptons:muons@+ EmuVetoLeptons:electrons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allEmuVetoMuonsElectronsSameSign = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string(''),
    decay = cms.string('EmuVetoLeptons:muons@+ EmuVetoLeptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allEmuVetoMuonsMinusElectronsMinus = cms.EDProducer("Zprime2muCombiner",
...
process.allEmuVetoMuonsMinusElectronsPlus = cms.EDProducer("Zprime2muCombiner",
...
process.allEmuVetoMuonsPlusElectronsMinus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == -2'),
    decay = cms.string('EmuVetoLeptons:muons@+ EmuVetoLeptons:electrons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allEmuVetoMuonsPlusElectronsPlus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == -24'),
    decay = cms.string('EmuVetoLeptons:muons@+ EmuVetoLeptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsElectronsAllSigns = cms.EDProducer("Zprime2muCombiner",
    checkCharge = cms.bool(False),
    cut = cms.string(''),
    decay = cms.string('Our2016Leptons:muons@+ Our2016Leptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
)


process.allOur2016MuonsElectronsOppSign = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string(''),
    decay = cms.string('Our2016Leptons:muons@+ Our2016Leptons:electrons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsElectronsSameSign = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string(''),
    decay = cms.string('Our2016Leptons:muons@+ Our2016Leptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsMinusElectronsMinus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == 24'),
    decay = cms.string('Our2016Leptons:muons@- Our2016Leptons:electrons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsMinusElectronsPlus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == 2'),
    decay = cms.string('Our2016Leptons:muons@- Our2016Leptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsPlusElectronsMinus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == -2'),
    decay = cms.string('Our2016Leptons:muons@+ Our2016Leptons:electrons@-'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allOur2016MuonsPlusElectronsPlus = cms.EDProducer("Zprime2muCombiner",
    cut = cms.string('daughter(0).pdgId() + daughter(1).pdgId() == -24'),
    decay = cms.string('Our2016Leptons:muons@+ Our2016Leptons:electrons@+'),
    loose_cut = cms.string('isGlobalMuon && isTrackerMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
...
process.allSimpleMuonsAllSigns = cms.EDProducer("Zprime2muCombiner",
    ...
    loose_cut = cms.string('isGlobalMuon && pt > 53 && abs(eta) < 2.4 && abs(dB) < 0.2 && isolationR03.sumPt / innerTrack.pt < 0.10 && globalTrack.hitPattern.trackerLayersWithMeasurement > 5 && globalTrack.hitPattern.numberOfValidPixelHits > 0 && globalTrack.hitPattern.numberOfValidMuonHits > 0 && numberOfMatchedStations > 1'),
    tight_cut = cms.string('userFloat("TriggerMatchPt") > 50 ')
)
...
process.EmuVetoMuonsElectronsAllSignsHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsElectronsAllSigns"),
    ...
    lepton_src = cms.InputTag("EmuVetoLeptons","muons"),
...
process.EmuVetoMuonsElectronsOppSignHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsElectronsOppSign"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.EmuVetoMuonsElectronsSameSignHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsElectronsSameSign"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.EmuVetoMuonsMinusElectronsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsMinusElectronsMinus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.EmuVetoMuonsMinusElectronsPlusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsMinusElectronsPlus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.EmuVetoMuonsPlusElectronsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsPlusElectronsMinus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.EmuVetoMuonsPlusElectronsPlusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("EmuVetoMuonsPlusElectronsPlus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsElectronsAllSignsHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsElectronsAllSigns"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsElectronsOppSignHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsElectronsOppSign"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsElectronsSameSignHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsElectronsSameSign"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsMinusElectronsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsMinusElectronsMinus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsMinusElectronsPlusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsMinusElectronsPlus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsPlusElectronsMinusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsPlusElectronsMinus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.Our2016MuonsPlusElectronsPlusHistos = cms.EDAnalyzer("Zprime2muHistosFromPAT",
    beamspot_src = cms.InputTag("offlineBeamSpot"),
    dilepton_src = cms.InputTag("Our2016MuonsPlusElectronsPlus"),
    hardInteraction = cms.PSet(
        allowFakeResonance = cms.bool(True),
        doingElectrons = cms.bool(False),
        resonanceIds = cms.vint32(32, 23, 39, 5000039),
...
process.SimpleNtuplerEmu = cms.EDAnalyzer("SimpleNtupler_miniAOD",
    TriggerResults_src = cms.InputTag("TriggerResults","","PAT"),
    beamspot_src = cms.InputTag("offlineBeamSpot"),
